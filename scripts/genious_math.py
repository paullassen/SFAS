...
def unknown_frame(x1, y1, x2, y2, w1, z1, w2, z2):
	...
	#print(rot2)
	unknown_frame = []
	if unknown_cand[0] > 4.5 or unknown_cand[0] < -0.5 or abs(unknown_cand[1] > 4):
		unknown_frame = [[ unknown_cand[2],  unknown_cand[3], rot2[0]],[unknown_cand[0], unknown_cand[1], rot1[0]]]
	elif unknown_cand[2] > 4.5 or unknown_cand[2] < -0.5 or abs(unknown_cand[3] > 4):
		unknown_frame = [[unknown_cand[0], unknown_cand[1], rot1[0]],[ unknown_cand[2],  unknown_cand[3], rot2[0]]]
	else:
		dif1 = abs(rot1[0]-rot1[1])
		dif2 = abs(rot2[0]-rot2[0])
